                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('admin.mahasiswa.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <textarea required type="text" class="form-control" name="judul"></textarea>
                                </div>

                                <div class="form-group">
                                <label for="exampleInputUsername1">Keterangan TA</label>
                                <textarea required type="text" class="form-control" name="keterangan"></textarea>
                                </div>
